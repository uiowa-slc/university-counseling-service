...
small{ font-size: 85%; }
 h2, h3, h4{ color: rgb(51, 51, 51); font-family: proxima-nova-condensed, sans-serif; margin-top: 1em; margin-right: 0px; margin-bottom: 0.5em; margin-left: 0px; letter-spacing: 1px; line-height: 1.1; font-weight: 600; text-rendering: optimizelegibility; }
h2{ font-size: 2.2rem; }
...
@media screen and (min-width: 768px){
.nav-main a{ border-bottom-style: none; border-bottom-width: initial; border-bottom-color: initial; color: rgb(51, 51, 51); font-family: proxima-nova-condensed, sans-serif; font-size: 1.13333rem; font-weight: 300; letter-spacing: 0.05em; line-height: 1.3125em; padding-top: 0.25em; padding-right: 0.9em; padding-bottom: 0.55em; padding-left: 0.9em; text-transform: uppercase; white-space: nowrap; }
}
@media screen and (min-width: 980px){
.nav-main a{ font-size: 1.33333rem; padding-top: 0.25em; padding-right: 1.2em; padding-bottom: 0.55em; padding-left: 1.2em; }
}
@media screen and (min-width: 1140px){
.nav-main a{ padding-top: 0.25em; padding-right: 1.55em; padding-bottom: 0.55em; padding-left: 1.55em; }
}
.nav-main li:last-child a{ border-bottom-style: none; border-bottom-width: initial; border-bottom-color: initial; }
@media screen and (min-width: 768px){
.nav-main .active a{ background-image: url(../../../themes/ucs/images/nav_hover.gif); background-attachment: initial; background-origin: initial; background-clip: initial; background-color: initial; background-position: 0% 100%; background-repeat: repeat no-repeat; }
...
@media screen and (min-width: 480px){
.footer-nav a{ border-left-width: 1px; border-left-style: solid; border-left-color: rgb(46, 46, 46); font-size: 0.8rem; padding-top: 5px; padding-right: 0px; padding-bottom: 5px; padding-left: 10px; }
}
@media only screen and (max-width: 480px){
...
.container{ margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; max-width: 1140px; padding-top: 0px; padding-right: 1em; padding-bottom: 0px; padding-left: 1em; position: relative; }
@media screen and (min-width: 768px){
...
.padding{ padding-top: 3em; padding-right: 0px; padding-bottom: 3em; padding-left: 0px; }
.header{ background-image: url(../../../themes/ucs/images/nav_yellow.gif); background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(255, 255, 255); position: relative; background-position: 0% 100%; background-repeat: repeat no-repeat; }
...
.mod{ font-size: 0.86667rem; line-height: 1.4; position: relative; }
.mod li{ margin-bottom: 1em; }
.mod h3{ border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(221, 221, 221); font-size: 1.4rem; margin-bottom: 0.8em; padding-bottom: 5px; text-transform: uppercase; }
.mod-news small{ display: block; }
.mod a{ }
